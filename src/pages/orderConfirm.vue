        ...
        <div class="edit-wrap">
          ...
          <div class="item">
            ...
            >
              <option
                :value="item"
                v-for="(item, i) in pcaList[checkedItem.province][checkedItem.city]"
                :key="i"
              >
                {{ item }}
              </option>
...
export default {
  ...
  methods: {
    querySearch(queryString, cb) {
      ...
      // 请求百度地图web服务api地址
      let url =
        "/place/v2/search?query=" +queryString +
        "&region=" +region +
        "&output=json&ak=eWbg02Ap6r2CoGYBoua6pVn8MHNpOjXl";

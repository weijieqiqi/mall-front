      ...
      <div class="container">
        <div class="order-box">
          ...
          <div class="order" v-for="(order,index) in list" :key="index">
            ...
            <div class="order-content clearfix">
              <div class="good-box fl">
                <div class="good-list" v-for="(item,i) in order.orderItemList" :key="i">
                  ...
                  <div class="good-name">
                    <div class="p-name">{{item.productName}}{{"+"}}{{item.sp1}}+{{item.sp2}}</div>
            ...
            <div class="order-title">
               <div class="item-info fl"> <span >收货地址：{{order.receiverProvince}}{{order.receiverCity}}{{order.receiverRegion}}{{order.receiverDetailAddress}}</span></div>
            </div>

      ...
      <div class="container">
          ...
          <ul class="cart-item-list">
            <li class="cart-item" v-for="(item,index) in list" v-bind:key="index">
              ...
              <div class="item-name">
               ...
               <div class="item-price">{{item.sp1}}</div>
               <div class="item-price">{{item.sp2}}</div>
        ...
        <div class="order-wrap clearfix">
          <div class="cart-tip fl">
            <a href="/#/index">继续购物</a>
            共<span>{{list.length}}</span>件商品，已选择<span>{{checkedNum}}</span>件，总价<span>{{calcSum}}</span>元 
          </div>
          <div class="total fr">
      ...
      renderData(res){
        ...
        this.list.map((item)=>{
          if(item.productSelected==undefined){
              item.productSelected=false;//复选框默认false
          }
        }); 
